# DEPRECATED — `aiforge_core.context`

Pre-archetype top-level context package. Replaced by the pluggable
archetype at `aiforge_core/aiforge_agents/archetypes/context.py`
