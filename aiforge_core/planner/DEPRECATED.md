# DEPRECATED — `aiforge_core.planner`

Pre-archetype top-level planner package. Replaced by the pluggable
archetype at `aiforge_core/aiforge_agents/archetypes/planner.py`
