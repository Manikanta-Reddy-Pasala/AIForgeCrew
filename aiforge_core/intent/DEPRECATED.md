# DEPRECATED — `aiforge_core.intent`

Pre-archetype top-level intent package. Replaced by the pluggable
archetype at `aiforge_core/aiforge_agents/archetypes/intent.py`
