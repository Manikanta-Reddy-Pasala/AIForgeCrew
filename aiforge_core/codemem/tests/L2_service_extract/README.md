...
or directly:
    ...
    pytest aiforge_core/codemem/tests/L2_service_extract/ -v
...
- `aiforge-codemem services <repo>` prints both services with file_count
...
`aiforge-codemem services l2_smoke`:
