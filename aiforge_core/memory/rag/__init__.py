...
from aiforge_core.memory.rag.indexer import (  # noqa: F401
    ReindexResult,
    reindex_repo,
)
...
if _backend == "neo4j":
    from aiforge_core.memory.rag.neo4j_memory import (  # noqa: F401
        retrieve_for_role_li,
        retain_fact,
        write_t1,
    )
else:
    from aiforge_core.memory.rag.retriever import retrieve_for_role_li  # noqa: F401
