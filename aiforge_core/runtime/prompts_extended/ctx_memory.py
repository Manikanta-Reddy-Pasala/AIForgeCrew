...
PROMPT = (
    ...
    "\n"
    "Keep it short and RANKED by relevance — lead with the fact that most "
    "changes how the team should plan or code this; drop low-signal hits "
    "entirely. If memory has nothing relevant, say so in one line. Do "
