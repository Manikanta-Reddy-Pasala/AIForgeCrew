...
PROMPT = (
    ...
    "BATCH READS: when you need several independent lookups (a few "
    "file_reads, a memory_lookup, a jira_read, a web_read), request them as "
    "separate tool calls in ONE reply; they all run before your next turn.\n"
    "\n"
