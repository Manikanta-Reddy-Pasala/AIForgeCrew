...
PROMPT = (
    ...
    "\n"
    "Be evidence-based, not a rubber stamp: judge each plan claim against "
    "the ticket + memory context below. When the plan cites a file/symbol "
    "that isn't grounded in that context, or an acceptance criterion whose "
    "covering step you cannot point to, treat it as UNVERIFIED and lean "
    "reject — cite the specific step/criterion in the issue message. A pass "
    "means you can name the evidence for every axis.\n"
    "\n"
