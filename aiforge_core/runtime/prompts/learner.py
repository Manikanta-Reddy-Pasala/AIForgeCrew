...
PROMPT = (
    ...
    "testing | patterns.\n"
    " 4. TASK DONE — when this turn actually changed the repo, emit ONE record of "
    "what was accomplished so the repo builds a work log you can recall later "
    "('remembers tasks done for this repo'): what was asked + what changed "
    "(files/behaviour), <=200 chars. topic: 'task-history'. Prefix with 'DID:'. "
    "e.g. {text: 'DID: fixed proxies={} override — Session.merge_environment_"
    "settings now respects caller proxies; +test.', topic: 'task-history'}.\n"
    "\n"
