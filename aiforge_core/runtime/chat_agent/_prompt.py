...
- serve         {{"cmd": "npm run dev", "port": 5173, "ttl_s": 1800}}   (START a server/app in the BACKGROUND; returns its pid + the URL to open — use this to run the app, NOT run_command which would block. It is stopped after ttl_s seconds (default 30 min); pass "ttl_s": 0 to keep it for a long run)
