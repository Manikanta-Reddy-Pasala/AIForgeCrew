...
CATALOG: dict = {
    ...
    "codegraph_explore": ("Explore the code graph around a symbol/topic.",
                          {"query": "s", "symbol": "s"}, ()),
    # ── Jira ─────────────────────────────────────────────────────────────
    "jira_search": ("Find Jira issues (query or jql).",
                    {"query": "s", "jql": "s", "limit": "s", "time": "b"}, ()),
    "jira_read": ("Read a Jira issue.", {"key": "s"}, ("key",)),
    ...
    "jira_dashboard_create": ("Create a dashboard.",
                              ...
                              ("name",)),
    # ── Confluence ───────────────────────────────────────────────────────
    "confluence_search": ("Find Confluence pages (query or cql).",
                          {"query": "s", "cql": "s"}, ()),
    "confluence_read": ("Read a page (id, or title+space).",
                        {"id": "s", "title": "s", "space": "s"}, ()),
    "confluence_create": ("Create a page.",
                          {"title": "s", "space": "s", "body": "s",
                           "parent_id": "s"}, ("title", "space", "body")),
    "confluence_update": ("Edit a page.",
                          {"id": "s", "body": "s", "title": "s"},
                          ("id", "body")),
    ...
    "confluence_comments": ("Read a page's comments.", {"id": "s"}, ("id",)),
    "confluence_comment": ("Add a comment to a page.", {"id": "s", "body": "s"},
                           ("id", "body")),
    "confluence_resolve_space": ("Loose space name → space key.",
                                 {"name": "s"}, ("name",)),
    # ── GitLab ───────────────────────────────────────────────────────────
    "gitlab_search": ("Find GitLab issues.",
                      {"query": "s", "project": "s", "state": "s"}, ()),
    "gitlab_read": ("Read a GitLab issue.", {"project": "s", "iid": "i"},
                    ("project", "iid")),
    "gitlab_create": ("Create a GitLab issue.",
                      {"project": "s", "title": "s", "description": "s",
                       "labels": "arrs"}, ("project", "title")),
    "gitlab_update": ("Edit a GitLab issue.",
                      {"project": "s", "iid": "i", "title": "s",
                       "labels": "arrs", "state_event": "s"}, ("project", "iid")),
    "gitlab_comment": ("Comment on a GitLab issue.",
                       {"project": "s", "iid": "i", "body": "s"},
                       ("project", "iid", "body")),
    "gitlab_mr_create": ("Open a GitLab merge request.",
                         {"project": "s", "source_branch": "s",
                          "target_branch": "s", "title": "s", "description": "s"},
                         ("project", "source_branch", "target_branch", "title")),
    "gitlab_mr_comment": ("Comment on a GitLab MR.",
                          {"project": "s", "iid": "i", "body": "s"},
                          ("project", "iid", "body")),
    # ── email ────────────────────────────────────────────────────────────
