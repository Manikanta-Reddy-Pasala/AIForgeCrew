...
from aiforge_core.orchestrator import agent_runner, tool_registry
...
def test_run_archetype_calls_run() -> None:
    ...
    with patch(
        ...
        "aiforge_core.memory.code_context.query",
        return_value="ctx_md",
    ):
...
def test_resilient_json_parse_strict() -> None:
    from aiforge_core.orchestrator.llm_client import (
