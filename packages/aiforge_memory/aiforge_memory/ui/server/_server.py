"""FastAPI app factory + blocking server entrypoint."""
...
from ._graphify import _resolve_graphify_path
...
def build_app():
    ...
    async def graphify_list():
        ...
        """
        # Route through the package object so a monkeypatch of
        # ``aiforge_memory.ui.server._graphify_index`` is still honoured.
